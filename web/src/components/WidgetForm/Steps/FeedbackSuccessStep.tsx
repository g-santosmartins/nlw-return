    ...
    return (
        <>
            ...
            <div className="flex flex-col items-center py-10 w-[304px]">
                ...
                <span className="text-xl mt-2">Agradecemos pelo seu feeback!</span>

                <button
                onClick={()=> onFeedRestartRequested()}
                type="button"
                    className="py-2 px-6 mt-6 bg-zinc-800 rounded-md border-transparent text-sm leading-4
                    hover:bg-zinc-700 focus:border-brand-500
